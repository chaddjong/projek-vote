...
export default function Share({ closeModal }) {
  ...
  return (
    <div className="relative flex flex-col justify-center items-center">
      <div className="flex flex-col justify-center items-start bg-white rounded-[13px] w-[80%] lg:h-[70vh] lg:w-[50vw] pb-2">
        ...
        <div className="w-[100%] flex flex-col items-center justify-end mt-5">
          <div class="w-[60vw] lg:w-[40vw] bg-[#d9d9d9] rounded-full py-[1vw] flex items-center lg:h-[10vh]">
            ...
            <div class="w-[60%] ml-[4%] ">
              ...
              <p className="text-[2vw] md:text-[1.5vw] lg:text-[1vw]">
