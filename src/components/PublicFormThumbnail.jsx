...
export default function PublicFormThumbnail(props) {
  ...
  return (
    <div
      id="btn_PbcForm"
      className="flex justify-evenly bg-white w-[41%] h-[13vh] lg:h-[19vh] rounded-r-2xl rounded-l-md hover:bg-[#FFB546] mx-[4.2%] mt-5 lg:bg-[#d9d9d9] active:bg-orange-400 shadow-md shadow-black"
    >
